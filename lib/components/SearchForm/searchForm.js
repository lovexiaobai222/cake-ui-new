...
var SearchForm = /*#__PURE__*/function (_React$Component) {
  ...
  function SearchForm(_props) {
    ...
    _this.getField = function (item) {
      ...
      var FormItemContainer = function FormItemContainer(_ref) {
        ...
        }, /*#__PURE__*/_react["default"].createElement(FormItem, _extends({}, item, {
          label: item.name,
          name: item.keyName,
      ...
      switch (item.type) {
        case "text":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.Input, _extends({}, item, {
        ...
        case "number":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.InputNumber, _extends({}, item, {
            disabled: item.disabled,
            max: item.max,
            min: item.min,
            onChange: function onChange(e) {
        ...
        case "switch":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.Switch, _extends({}, item, {
            checkedChildren: "ON",
        ...
        case "radio":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(RadioGroup, _extends({}, item, {
            buttonStyle: "outline",
            disabled: item.disabled,
            onChange: function onChange(e) {
              item.onChange && item.onChange(e, _this.formRef);
        ...
        case "radioTag":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_checkTagGroup["default"], _extends({}, item, {
            disabled: item.disabled,
        ...
        case "select":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.Select, _extends({}, item, {
            ...
            return /*#__PURE__*/_react["default"].createElement(Option, _extends({}, op, {
              key: op.value,
              value: op.value
            }), op.label);
          })));
        ...
        case "selectTree":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.TreeSelect, _extends({}, item, {
            allowClear: true,
            dropdownStyle: {
              maxHeight: 300,
              overflow: "auto"
        ...
        case "date":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(_antd.DatePicker, _extends({}, item, {
            disabled: item.disabled,
        ...
        case "dateRange":
          return /*#__PURE__*/_react["default"].createElement(FormItemContainer, {
            item: item
          }, /*#__PURE__*/_react["default"].createElement(RangePicker, _extends({}, item, {
            disabled: item.disabled,
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_antd.Form, {
      ...
      type: "flex",
      className: "main"
    }, this.getFields(), /*#__PURE__*/_react["default"].createElement(_antd.Col, _extends({
      span: 4,
      className: "btn-container"
    }, buttonConfig), buttonConfig.showSearchBtn ? /*#__PURE__*/_react["default"].createElement(_antd.Button, {
      htmlType: "submit",
      type: "primary"
    }, "\u67E5\u8BE2") : null, buttonConfig.showResetBtn ? /*#__PURE__*/_react["default"].createElement(_antd.Button, {
    ...
    }, "\u91CD\u7F6E") : null, buttonConfig.customChildren ? buttonConfig.customChildren(this.formRef) : null, buttonConfig.collapse ? /*#__PURE__*/_react["default"].createElement("span", {
      style: {
        marginLeft: 8,
        fontSize: 12
      }
    ...
    }, this.state.expand ? "收起" : "展开", this.state.expand ? /*#__PURE__*/_react["default"].createElement(_icons.CaretUpOutlined, null) : /*#__PURE__*/_react["default"].createElement(_icons.CaretDownOutlined, null))) : null)));
  };
