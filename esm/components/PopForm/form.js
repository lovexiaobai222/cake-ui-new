...
var MyForm = /*#__PURE__*/function (_React$Component) {
  ...
  function MyForm(props) {
    ...
    _this.getField = function (item) {
      switch (item.type) {
        case "text":
          return /*#__PURE__*/React.createElement(Input, _extends({}, item, {
        ...
        case "number":
          return /*#__PURE__*/React.createElement(InputNumber, _extends({}, item, {
            disabled: item.disabled,
        ...
        case "verify":
          return /*#__PURE__*/React.createElement(Search, _extends({}, item, {
            className: "verify",
            disabled: false,
        ...
        case "textarea":
          return /*#__PURE__*/React.createElement(TextArea, _extends({}, item, {
            autosize: {
              minRows: item.rows || 2,
              maxRows: 6
            },
        ...
        case "radio":
          return /*#__PURE__*/React.createElement(RadioGroup, _extends({}, item, {
            buttonStyle: "outline",
            onChange: function onChange(e) {
              item.onChange && item.onChange(e, _this.formRef);
            },
        ...
        case "checkbox":
          return /*#__PURE__*/React.createElement(CheckboxGroup, _extends({}, item, {
            disabled: item.disabled,
            onChange: function onChange(e) {
              item.onChange && item.onChange(e, _this.formRef);
            },
        ...
        case "select":
          return /*#__PURE__*/React.createElement(Select, _extends({}, item, {
        ...
        case "date":
          ...
          return /*#__PURE__*/React.createElement(DatePicker, _extends({}, item, {
            disabled: item.disabled,
        ...
        case "dateRange":
          return /*#__PURE__*/React.createElement(RangePicker, _extends({}, item, {
            disabled: item.disabled,
        ...
        case "file":
          return /*#__PURE__*/React.createElement(MyUpload, _extends({}, item, {
            form: _this.formRef
          }));
        // 自定义组件
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement(Form, {
      ...
      return /*#__PURE__*/React.createElement(FormItem, _extends({}, item, formItemLayout, item.formItemLayout, {
    ...
    }, buttonConfig), buttonConfig && buttonConfig.beforeCustomChildren ? buttonConfig.beforeCustomChildren() : null, buttonConfig && buttonConfig.showCancelBtn ? /*#__PURE__*/React.createElement(Button, {
      onClick: function onClick() {
        return onCancel && onCancel();
      }
    }, cancelText || "取消") : null, buttonConfig && buttonConfig.showOkBtn ? /*#__PURE__*/React.createElement(Button, {
      htmlType: "submit",
      type: "primary",
      style: {
        marginLeft: 16
